...
"""
Enhanced configuration with signal-specific optimizations for deconvolved signal superiority.
"""
import torch
...
DEFAULT_CONFIG = {
    ...
    # Model parameters with signal-specific optimizations
    "models": {
        "random_forest": {
            "n_estimators": 300,
            "max_depth": 15,
        ...
        "mlp": {
            "hidden_layer_sizes": (128, 256, 128, 64),  # Deeper architecture
            "activation": "relu",
            "solver": "adam",
            "alpha": 0.0001,
            "batch_size": "auto",
        ...
        "fcnn": {
            "hidden_dims": [512, 256, 128],  # Will be modified by signal type
            "output_dim": 2,
            "dropout_rate": 0.4,
            "learning_rate": 0.001,
            "weight_decay": 1e-5,
        ...
        "cnn": {
            "n_filters": [32, 64, 128],  # Will be modified by signal type
    ...
    "training": {
        ...
        "device": "cuda" if torch.cuda.is_available() else "cpu",
        "output_dir": "outputs/results",
        "use_signal_specific_training": True  # Enable signal-specific optimizations
    },

    # Signal-specific training multipliers
    "signal_multipliers": {
        "deconv_signal": {
            "learning_rate": 0.5,  # Lower learning rate
            "epochs": 1.5,  # More epochs
            "patience": 2.0,  # More patience
            "dropout": 0.7,  # Less dropout
            "weight_decay": 0.5,  # Less L2 regularization
            "batch_size": 0.5  # Smaller batches
        },
        "calcium_signal": {
            "learning_rate": 1.2,
            "epochs": 1.0,
