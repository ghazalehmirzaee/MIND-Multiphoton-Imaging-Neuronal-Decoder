# mind/visualization/neuron_overlap.py
"""
...
def create_neuron_venn_diagram(
    ...
    """
    Create an Venn diagram showing the overlap of top contributing neurons.

    This is a wrapper function that loads the data and creates the visualization.
